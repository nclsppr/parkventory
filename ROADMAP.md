...
| 5 | F05 | Pilote fiable | Des collègues utilisent le flux sur mobile et desktop | `planned` | Notifications, accessibilité, observabilité et pilote contrôlé | 34 tests React, 24 audits Axe et revue clavier/mobile ; appareils réels, technologies d'assistance et pilote encore requis | |
